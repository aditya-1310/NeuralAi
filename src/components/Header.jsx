    ...
    backdrop-blur-sm border-n-6 lg:bg-n-8/90lg:backdrop-blur-sm">
        ...
        <div className="relative z-2 flex flex-col item-center jsutify-center m-auto lg:flex-row">
            {navigation.map((item=>(
                ...
                transition-color hover:text-color-1 ${item.onlyMobile ? "lg:hidden" :""} px-6  py-6 md:py-8 lg:-mr-0.25 lg:text-xs lg:font-semibold
                ${
        ...
        <a href ="#signup"
        className="button hidden mr-8 text-n-1/50 transition-color hover:text-n-1 lg:block"> NEW ACCOUNT
        </a>
        <Button
